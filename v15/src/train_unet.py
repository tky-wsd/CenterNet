...
def main(args):
    ...
    if args.yaw is not None and args.yaw > 0:
        ...
        criterions['yaw'] = StackedAngleLoss(metrics='cos_sim')
    ...
    if args.roll is not None and args.roll > 0:
        num_out_features = 2
        head_list.append(('roll', output_hidden_channels, AngleNet(output_hidden_channels, num_out_features)))
        lambdas['roll'] = args.roll
        criterions['roll'] = StackedAngleLoss(metrics='cos_sim')
