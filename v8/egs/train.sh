...
if [ -z ${continue_epoch} ]; then
    ...
    model_option="${out_dir}/UNet_S${S}_C${C}_H${H}_heatmap${heatmap}_local_offset${local_offset}_depth${depth}_potential_map${potential_map}/epoch${continue_epoch}.pth"
fi
