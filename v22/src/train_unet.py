...
from criterion import StackedHeatmapLoss, StackedDepthLoss, StackedYawLoss, StackedCategoricalPitchLoss, StackedRollLoss, StackedAngleLoss, StackedL1Loss
...
parser.add_argument('--show_target_heatmap', type=int, default=None, help='Whether to show target heatmap on training')
...
def main(args):
    ...
    if args.yaw is not None and args.yaw > 0:
        ...
        criterions['yaw'] = StackedAngleLoss()
    ...
    if args.categorical_pitch is not None and args.categorical_pitch > 0:
        ...
        lambdas['categorical_pitch'] = args.categorical_pitch
        criterions['categorical_pitch'] = StackedCategoricalPitchLoss(num_category=4, gamma=args.gamma)
    if args.shifted_roll is not None and args.shifted_roll > 0:
        ...
        lambdas['shifted_roll'] = args.shifted_roll
        criterions['shifted_roll'] = StackedAngleLoss()
